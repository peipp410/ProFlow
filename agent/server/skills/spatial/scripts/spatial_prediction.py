...
def main():
    parser = argparse.ArgumentParser(prog="spatial_prediction.py")
    ...
    parser.add_argument("--scgpt_model_dir", default="/macroverse_tos/pjz/proteomics/tcga_coad/scgpt_model")
    parser.add_argument("--scgpt_model_state", default=None)
    parser.add_argument("--conch_checkpoint_path", default="/data/pjz_proteomics/proteomics_back/data_model/coach_model/pytorch_model.bin")
    ...
    parser.add_argument("--hist_flow_rna_ckpt", default="/macroverse_tos/pjz/proteomics/tcga_coad/HistFlowRNA_final.pt")
    parser.add_argument("--final_model_ckpt", default="/macroverse_tos/pjz/proteomics/tcga_coad/image_to_protein_final_15.pt")
    ...
    for tif_path in tqdm(tif_files, desc="Predicting"):
        ...
        if df_res is None:
            continue
        save_path = os.path.join(args.output_dir, f"{basename}_predictions.csv")
